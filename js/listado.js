...
Listado.prototype.buscarRestaurante = function(id) {
  var resto = this.restaurantes.find(function(element) {
...
//Creo una nueva fc sin repetidos
Listado.prototype.filtrar = function(filtroDelArray) {
  var sinRepetidos = filtroDelArray.filter(function(elem, index, self) {
...
Listado.prototype.obtenerHorario = function() {
  var horarios = [];
  horarios = this.restaurantes.reduce(function(
    nuevosHorarios,
    horariosRestaurant
  ) {
    return nuevosHorarios.concat(horariosRestaurant.horarios);
  },
  []);
